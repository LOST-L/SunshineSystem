...
<html>
    ...
    <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
        <ul class="layui-tab-title">
            ...
            <li onclick="updateAccept()">待接收任务</li>
            <li onclick="updateDoing()">进行中任务</li>
            <li onclick="updateDone()">已完成任务</li>
            <li onclick="updateCreate()">我发布的任务</li>
        </ul>
        <div class="layui-tab-content" style="height: 100px;">
            <div class="layui-tab-item layui-show">
                <div class="double">
                    <form id="newTaskForm" class="layui-form" style="width: 800px;">
                        ...
                        <div class="layui-form-item" id="repeatCreatTimeDiv" style="display: none">
            ...
            <div class="layui-tab-item ">
                <div style="width: 95%;height: 90%;margin-left: 30px;">
                    <table id="acceptTable" lay-filter="doingTable" lay-skin="nob"></table>
                </div>
            </div>
