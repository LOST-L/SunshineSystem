...
<head>
    ...
    <%--<link rel="stylesheet" href="<%=basePath%>page/style/admin.css" media="all">--%>
    ...
    <div class="layadmin-user-login-main" style="margin-top: 150px;">
        ...
        <div class="layadmin-user-login-box layadmin-user-login-body layui-form">
            <div class="layui-form-item">
                ...
                <input type="text" name="account" id="LAY-user-login-username" lay-verify="required" placeholder="请输入花名" class="layui-input">
            </div>
            <div class="layui-form-item">
