...
<div id = "topImage" style="height:100%;min-height:800px;width:100%;background-image: url('static/image/back.jpg');">
    ...
    <div class="lie">
        ...
        <div class="function" name = "sunshineRank" data-url="sunshine/sunshine_rank">
            <img src="static/image/Sun.png" width="60" height="60"><br>
            <span style="color: white;">阳光值排行</span>
        </div>
        <div class="function" name = "taskManage" data-url="sunshine/task_manage">
            <img src="static/image/gdSystem.png" width="60" height="60"><br>
            <span style="color: white;">任务系统</span>
        </div>
        <div class="function" name = "backlogManage" data-url="sunshine/backlog_manage">
            <img src="static/image/gdSystem.png" width="60" height="60"><br>
            <span style="color: white;">待办事项</span>
        </div>
        <div class="function" name = "sunshineManage" data-url="sunshine/sunshine_manage">
            <img src="static/image/Sun.png" width="60" height="60"><br>
            <span style="color: white;">阳光值管理</span>
        </div>
        <div class="function" name = "userManage" data-url="sunshine/user_manage">
            <img src="static/image/userSystem.png" width="60" height="60"><br>
            <span style="color: white;">员工管理</span>
        </div>
        <div class="function" name = "depManage" data-url="sunshine/department_manage"><%----%>
            <img src="static/image/depSystem.png" width="60" height="60"><br>
            <span style="color: white;">部门管理</span>
        </div>
        <div class="function" name = "employeeInfoManage" data-url="sunshine/employee_info_manage">
            <img src="static/image/userSystem.png" width="60" height="60"><br>
            <span style="color: white;">官网对外联系方式查询管理</span>
        </div>
...
--%>
        ...
        <span style="font-size:16px; color:greenyellow;">欢迎您：<%=u.getUserNickname()%></span>
        <br>
        <br>
        <u><a href="<%=basePath%>logout.do" style="font-size:16px; color:bisque; " >退出系统</a></u>
    </div>
    <div class="lie">

        <div class="function" name = "depSystem" data-url="plan/CountUserList">
            <img src="static/image/gdSystem.png" width="60" height="60"><br>
            <span style="color: white;">京云策划-用户管理</span>
        </div>
        <div class="function" name = "depSystem" data-url="plan/CategoryList">
            <img src="static/image/gdSystem.png" width="60" height="60"><br>
            <span style="color: white;">京云策划-类目管理</span>
        </div>
    </div>
<%--    <div class="lie">
