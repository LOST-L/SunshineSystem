                    ...
                    if (data.code == 200) {
                        table.render({
                            ...
                            cols: [[ //表头
                                ...
                                ,{align:'center',field: 'userQQ', title: '企业QQ',edit:'text',width:120}
                                ,{align:'center',field: 'userWechat', title: '工作微信',edit:'text',width:120}
                                ,{align:'center',field: 'userMail', title: '邮件地址',edit:'text',width:197}
                                ,{align:'center',field: 'userJoinDate', title: '入职时间', sort: true,width:105}
                                /* ,{align:'center',field: 'howLong', title: '在职时长', sort: true}*/
                                ,{align:'center',title: '操作',toolbar: '#barDemo', fixed: 'right',width:200}
                            ]]
                        })
                    }
                }
